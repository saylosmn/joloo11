...
800 асуулт, 33 бүлэг. Бүлгээр давтаж, жинхэнэ шалгалт (20 асуулт / 25 минут) өгнө.
...
- **Бүлгээр давтах** — 33 бүлэг, гүйцэтгэлийн progress bar, хариулсан даруйд зөв/буруу нь өнгө + icon + haptic
...
| | Free | PRO |
|---|---|---|
| Бүлгээр давтах | Эхний 2 бүлэг | Бүх 33 бүлэг |
...
> **автоматаар seed** хийнэ (800 асуулт / 33 бүлэг / 226 зураг). Тиймээс шинэ deploy дээр гараар
...
## Excel seed + validation

`python scripts/seed.py` дараах зүйлийг хийнэ:

1. `data/ZHD_800.xlsx`-ийг уншина (хуудас: *Асуулт*).
2. **Validation** — асуулт бүр ≥2 хариулттай эсэх, зөв хариулт яг нэг заагдсан эсэх, хоосон текст, давхардал (зурагтай асуултын давтагдах текстийг давхардал гэж үзэхгүй), бүлэг тодорхойлогдсон эсэх.
3. Алдаатай мөрийг `scripts/skipped_rows.json`-д мөрийн дугаар + шалтгаантай нь бичнэ.
4. Асуултын текст, хариултыг **үсэг үсгээр нь яг хуулж** авна (засварлахгүй).
5. Зурагтай асуултын зургийг задлан `data/images/`-д хадгалж, `imageUrl`-д замыг тавина.
6. Бүлгийг Excel-ийн ангиллын баганаар нь хуваана.
7. Терминалд тайлан хэвлэнэ: нийт асуулт, бүлэг бүрийн тоо, алдаатай мөр, MongoDB дахь тоо Excel-тэй таарч байгааг баталгаажуулна.

**Эцсийн үр дүн:** 800 асуулт, 33 бүлэг, 226 зурагтай, **0 алдаатай мөр**. MongoDB дахь тоо (800) Excel-ийн мөртэй бүрэн таарна.
...
Эхний асаалт дээр 33 бүлэг, 800 асуулт **автоматаар seed** хийгдэнэ (DB хоосон
