...
## Асуултын сан шинэчлэгдсэн

- [x] `ZHD_800_asuult_zuragtai_shinechilsen.xlsx`-ээс бүх асуултыг сольсон:
      **800 асуулт, 36 бүлэг, 800 зураг** (өмнө нь 33 бүлэг, зөвхөн 226 зурагтай).
      Хариултын хуваарилалт А/Б/В/Г = 200/200/200/200.
- [x] `backend/scripts/import_xlsx.py` — дахин ашиглаж болох импортлогч.
      Бүх мөр шалгалт давахаас нааш юу ч бичдэггүй; Excel-ийн `Хураангуй` хуудсан
      дахь бүлгийн тоотой тулгаж шалгадаг.
- [x] Бүлгийн тоо frontend дээр 6 газар хатуу бичигдсэн байсныг
      `src/lib/content.ts` тогтмол болгов.
